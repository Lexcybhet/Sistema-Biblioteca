  ...
  ?>
    <!-- Contenido -->
      <section class="main container">
        <div class="contenido">
          <center><H3>Lo sentimos. Su usuario no tiene acceso a este modulo</H3></center>
          <center><img style="margin:5px;" src="Imagenes/Negado.png" width="300" height="250"></center>
        </div>
      </section>
<!-- Scripts -->
  <?php 
